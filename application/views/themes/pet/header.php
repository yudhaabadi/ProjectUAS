	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          <li class="nav-item active"><a href="<?php echo base_url(); ?>" class="nav-link"><b>Home</b></a></li>
              ...
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="<?php echo site_url('shop/cart'); ?>"><b>Keranjang Belanja</b></a>
                <a class="dropdown-item" href="<?php echo site_url('customer/payments/confirm'); ?>"><b>Konfirmasi Pembayaran</b></a>
              </div>
            </li>
			<li class="nav-item"><a href="<?php echo site_url('pages/petshop'); ?>"class="nav-link"><b>Petshop</b></a></li>
              <li class="nav-item"><a href="<?php echo site_url('pages/contact'); ?>" class="nav-link"><b>Kontak</b></a></li>
			  <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>Layanan</b></a>
              <div class="dropdown-menu" aria-labelledby="dropdown04">
                <a class="dropdown-item" href="<?php echo site_url('pages/petclinic'); ?>">PetClinic</a>
                <a class="dropdown-item" href="<?php echo site_url('pages/petgrooming'); ?>">PetGrooming</a>
				<a class="dropdown-item" href="<?php echo site_url('pages/pethotel'); ?>">PetHotel</a>
              </div>
              <li class="nav-item dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown05" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><b>Akun</b></a>
